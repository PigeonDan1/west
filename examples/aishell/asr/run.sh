...
data=data
dir=exp/Qwen2-7B-Instruct-firered/debug/ziyi_data-stage1-asr_projector_frozen-from_ziyi_4000_steps #stage1-asr_projector_frozen-from_ziyi_4000_steps
...
if [ $stage == "train" ] || [ $stage == "all" ]; then
    ...
    torchrun --standalone --nnodes=1 --nproc_per_node=$num_gpus west/bin/train.py \
        ...
        --data_path $data/train.ziyi.jsonl \
        --output_dir $dir \
        --pack_size 8192 \
        --bf16 True \
        --max_steps $steps \
