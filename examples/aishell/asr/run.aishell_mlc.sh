...
data=data
dir=exp/Qwen2-7B-Instruct-firered/debug/aishell_mlc_data-stage1-asr_projector_frozen-from_ziyi_4000_steps #stage1-asr_projector_frozen-from_ziyi_4000_steps
...
model_conf="conf/qwen2-7b_firered-speaker_attributed.json" #conf/qwen2-7b_firered.json
...
if [ $stage == "decode" ] || [ $stage == "all" ]; then
    ...
    #     echo ${step}
    #     mdir=exp/Qwen2-7B-Instruct-firered/debug/aishell_mlc_data-stage1-asr_projector_frozen-from_ziyi_4000_steps/checkpoint-${step}
    #     cp $decode_conf $mdir
    ...
    mdir=exp/Qwen2-7B-Instruct-firered/debug/aishell_mlc_data-stage1-asr_projector_frozen-from_ziyi_4000_steps/checkpoint-450
    python west/bin/decode.py \
